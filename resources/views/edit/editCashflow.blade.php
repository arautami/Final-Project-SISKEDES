...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Cashflow</h1>
    </div>
    ...
    <!-- Basic Card Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit Cashflow</h6>
            </div>
            <div class="card-body">
                <form action="/updateCashflow/{{ $data->id }}" method="POST" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    ...
                    <div class="p-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="saldoKeluar" id="saldoKeluar" value="{{ $data->saldoKeluar }}">
                    </div>
                    <div class="p-3 col-md-6">
                        <label for="saldoMasuk" class="form-label">Saldo Masuk</label>
                        <input type="number" class="form-control" name="saldoMasuk" id="saldoMasuk" value="{{ $data->saldoMasuk }}">
                    </div>
